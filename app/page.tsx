...
const t = {
  en: {
    ...
    heroTitle1: "Rediscover the", heroTitle2: "Companions of the Prophet ﷺ",
    heroSub: "Premium bilingual e-books (Arabic & English) on the lives of the Sahabah — crafted for the modern Muslim reader.",
    ...
    feat1T: "Bilingual PDFs", feat1D: "Every book in Arabic & English, accessible to a global Muslim audience.",
  ...
  ar: {
    ...
    bismillah: "بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ",
    heroTitle1: "اكتشف من جديد", heroTitle2: "صحابة النبي ﷺ",
    heroSub: "كتب إلكترونية ثنائية اللغة عن حياة الصحابة — صُممت للقارئ المسلم المعاصر.",
    ...
    feat1T: "ملفات PDF ثنائية اللغة", feat1D: "كل كتاب بالعربية والإنجليزية.",
  ...
  fr: {
    ...
    bismillah: "بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ",
    heroTitle1: "Redécouvrez les", heroTitle2: "Compagnons du Prophète ﷺ",
    heroSub: "E-books bilingues premium sur les vies des Sahabah — conçus pour le lecteur musulman moderne.",
    ...
    feat1T: "PDFs bilingues", feat1D: "Chaque livre en arabe et anglais.",
  ...
  return (
    <div dir={isRtl ? "rtl" : "ltr"}>
      ...
      <header style={{ background: "var(--ink)", borderBottom: "2px solid var(--gold)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64, padding: "0 2rem", flexWrap: "wrap", gap: "0.5rem" }}>
          <div>
            <div style={{ fontFamily: "'Scheherazade New',serif", fontSize: 21, fontWeight: 700, color: "var(--gold-light)", lineHeight: 1 }}>مكتبة النور</div>
            <div style={{ fontSize: 10, color: "var(--gold-pale)", letterSpacing: ".15em", textTransform: "uppercase", opacity: .65 }}>MAKTABAT AL-NOUR</div>
          </div>
          <nav style={{ display: "flex", alignItems: "center", gap: "1.2rem", flexWrap: "wrap" }}>
            {(["en","ar","fr"] as Lang[]).map((l) => (
              <button key={l} onClick={() => setLang(l)}
                style={{ background: lang === l ? "var(--gold)" : "transparent", color: lang === l ? "var(--ink)" : "var(--parchment-dark)", border: "1px solid " + (lang === l ? "var(--gold)" : "rgba(255,255,255,.15)"), padding: "4px 10px", borderRadius: 2, fontSize: 11, fontWeight: 700, cursor: "pointer", textTransform: "uppercase" }}>
                {l.toUpperCase()}
              </button>
            ))}
            ...
            <button style={{ background: "var(--gold)", color: "var(--ink)", border: "none", padding: "8px 18px", borderRadius: 3, fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
              🛒 {tx.cart} ({cart.length})
            </button>
          </nav>
        </div>
            ...
            >
              ...
              <div style={{ padding: "1.2rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  ...
                  <span style={{ fontSize: 10, color: "var(--ink-mid)", background: "var(--parchment-dark)", padding: "2px 7px", borderRadius: 2, opacity: .7 }}>AR · EN</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 10, borderTop: "1px solid var(--parchment-dark)" }}>
                  ...
                  <button onClick={(e) => { e.stopPropagation(); window.open(book.shopierUrl, "_blank"); }}
                    style={{ background: "var(--gold)", color: "var(--ink)", border: "none", padding: "9px 16px", fontSize: 12, fontWeight: 700, borderRadius: 3, cursor: "pointer", letterSpacing: ".03em" }}>
                    {tx.buyNow}
                  </button>
                </div>
              </div>
